...
// The app repo's own Pages. The privacy policy has to stay there: its URL is
// registered with the Microsoft Store listing, so it cannot move with the site.
export const AETOX_PAGES = "https://mikedev115.github.io/Aetox/";
export const PRIVACY_URL = `${AETOX_PAGES}privacy.html`;
